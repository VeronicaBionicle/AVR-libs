...
class Timer0 {
  ...
  public:
    ...
    void attachTimerInterrupt(void (*isr)(), uint32_t Period) __attribute__((always_inline)) {  //attach function to ISR (function must be void without arguments!!!) and Period in microseconds
